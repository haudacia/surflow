...
const FormCard = ({ form }) => {
  ...
  return (
    <div
      className='relative h-32 text-sm flex flex-col justify-center flex-wrap p-4 shadow-sm bg-azure hover:shadow-none transition-all duration-500 hover:bg-white'
